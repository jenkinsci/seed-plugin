...
public class EventStrategyConfig {
     ...
     */
    @Wither
    private final boolean startAuto;

    @DataBoundConstructor
    public EventStrategyConfig(boolean delete, boolean auto, boolean trigger, String commit, boolean startAuto) {
        this.delete = delete;
        this.auto = auto;
